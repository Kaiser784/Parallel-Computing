...
int main()
{
    ...
    // cin >> 
    Pstr = "90659935589672134066418069661244537071942135986254663159165058746421811420293";
    // cin >>
    Qstr = "58309303853042539764661388376356487646503897140817194956479465954985166355731";
    // cin >>
    Estr = "65537";
    ...
    //     cin >> Operation;
        ...
        //     answer = MyNum.IsPrime(QArray);
                Print = MyNum.ToPrint(QArray);
                cout << "Q:" << Print << endl; 
                Print = MyNum.ToPrint(EArray);
                cout << "E:" << Print << endl; 
        ...
        // {
            ...
            // {
                msg ="307544207737943951363288472891362986097510918654030168414175278866222437123293942515732562114635604248417979457622899834036676310152557601215352043880320";
                msgArray = MyNum.StringToArray(msg);
